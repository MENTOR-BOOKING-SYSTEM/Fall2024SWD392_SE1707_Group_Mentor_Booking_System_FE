...
import { SubmitProjectForMentorFormValues } from './use-submit-project'
...
export default function SubmitProjectForm() {
  ...
  const {
    control,
    formState: { errors }
  } = useFormContext<SubmitProjectForMentorFormValues>()

  const getErrorState = (name: keyof SubmitProjectForMentorFormValues) => {
    return errors[name]
  }
