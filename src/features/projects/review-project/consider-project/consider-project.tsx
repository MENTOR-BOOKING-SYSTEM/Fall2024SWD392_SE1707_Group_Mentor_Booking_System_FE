...
interface ConsiderProjectProps {
  criterias: Criteria[] | null | undefined
}

export default function ConsiderProject({ criterias }: ConsiderProjectProps) {
  ...
  return (
    <div>
      <Button color='warning' variant='bordered' startContent={<CircleHelp />} onPress={onOpen}>
        Consider
      </Button>
      <Modal
        backdrop='blur'
